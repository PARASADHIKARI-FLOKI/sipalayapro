...
import img1 from "../../assets/img1.webp"; // Example for opportunity image
import img2 from "../../assets/img2.webp"; // Example for announcement image
    ...
    <div className="min-h-screen bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-white">
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-5xl font-extrabold">Recruiter Dashboard</h1>
          <p className="text-lg mt-2 opacity-80">
            Welcome, Recruiter! Manage your opportunities and announcements.
          </p>
        </div>
